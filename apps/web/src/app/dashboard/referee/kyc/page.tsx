...
export default function RefereeKYC() {
 ...
 <div className="flex items-center justify-between p-4 border-2 rounded-lg bg-gradient-to-br from-green-50/50 to-emerald-50/50 ">
 <div className="flex items-center gap-3">
...
function RefereeDocumentsUpload({ userId }: { userId: string }) {
 ...
 <div className="flex items-center gap-3">
 <div className="p-3 rounded-xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-200 ">
 <Icon className="h-6 w-6 text-blue-600 " />
 </div>
 <div>
 <CardTitle className="text-lg font-bold">{title}</CardTitle>
 <span className="inline-flex items-center mt-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-800 ">
 Required
 </span>
 </div>
 </div>
