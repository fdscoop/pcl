...
export default function SettingsPage() {
 ...
 {/* Profile Card */}
 <Card className="border-slate-200 bg-white hover:shadow-lg transition-all overflow-hidden">
 ...
 <div className="w-16 h-16 rounded-full bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center ring-2 ring-orange-200 ">
 ...
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Profile Photo</p>
 ...
 className="border-slate-200 focus:border-orange-500 focus:ring-orange-500/20 text-sm h-9"
 required
 />
 </div>
 ...
 disabled
 className="border-slate-200 bg-slate-50 text-sm h-9"
 />
 ...
 rows={3}
 className="border-slate-200 focus:border-orange-500 focus:ring-orange-500/20 text-sm resize-none"
 />
 </div>
 ...
 <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200 ">
 <div>
 ...
 <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Booking Alerts</p>
 <p className="text-xs text-slate-500 ">
 ...
 <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Payout Notifications</p>
 <p className="text-xs text-slate-500 ">
 ...
 <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Marketing Emails</p>
 <p className="text-xs text-slate-500 ">
 ...
 <CardContent className="pt-4 px-4 pb-4 space-y-2.5">
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 border border-slate-200 rounded-xl hover:border-orange-300 transition-colors">
 <div>
 ...
 <Button variant="outline" size="sm" className="text-xs h-8 border-slate-200 hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-all">
 Change Password
 </Button>
 </div>

 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 border border-slate-200 rounded-xl hover:border-emerald-300 transition-colors">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Two-Factor Authentication</p>
 <p className="text-xs text-slate-500 ">
 Add an extra layer of security
 </p>
 </div>
 <Button variant="outline" size="sm" className="text-xs h-8 border-slate-200 hover:bg-emerald-500 hover:text-white hover:border-emerald-500 transition-all">
 Enable 2FA
 </Button>
 </div>
 </CardContent>
 ...
 <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 px-4 py-3.5">
 <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
 ...
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Language</p>
 <p className="text-xs text-slate-500 ">
 ...
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Timezone</p>
 <p className="text-xs text-slate-500 ">
 ...
 {/* Danger Zone Card */}
 <Card className="border-red-200 bg-white hover:shadow-lg transition-all overflow-hidden">
 <div className="h-1 w-full bg-gradient-to-r from-red-500 to-rose-500"></div>
 <CardHeader className="bg-gradient-to-r from-red-50 to-rose-50 px-4 py-3.5">
 ...
 <CardContent className="pt-4 px-4 pb-4 space-y-2.5">
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 border border-red-200 rounded-xl bg-red-50/50 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Deactivate Account</p>
 <p className="text-xs text-slate-500 ">
 Temporarily disable your account
 </p>
 </div>
 <Button variant="outline" size="sm" className="text-xs h-8 text-red-600 border-red-300 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all">
 Deactivate
 </Button>
 </div>
 ...
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 border border-red-200 rounded-xl bg-red-50/50 ">
 <div>
 <p className="font-semibold text-sm text-slate-800 ">Delete Account</p>
 <p className="text-xs text-slate-500 ">
