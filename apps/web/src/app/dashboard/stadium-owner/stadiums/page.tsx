...
export default function StadiumsPage() {
 ...
 <div>
 <h1 className="text-xl sm:text-2xl font-bold text-slate-800 ">My Stadiums</h1>
 ...
 <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-100 to-amber-50 flex items-center justify-center mb-5">
 <Building2 className="h-8 w-8 text-orange-600 " />
 </div>
 <h3 className="text-lg font-bold text-slate-800 mb-1.5 text-center">No stadiums listed yet</h3>
 <p className="text-slate-500 text-center mb-5 max-w-sm text-sm">
 ...
 return (
 <Card key={stadium.id} className="group overflow-hidden border-slate-200 bg-white hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 hover:-translate-y-1">
 {/* Image Section */}
 ...
 <span
 key={idx}
 className="px-1.5 py-0.5 bg-orange-100 text-orange-600 text-[9px] rounded-full font-semibold"
 >
 {amenity}
 </span>
 ))}
 {stadium.amenities.length > 3 && (
 <span className="px-1.5 py-0.5 bg-slate-100 text-slate-500 text-[9px] rounded-full">
 +{stadium.amenities.length - 3}
 </span>
 )}
 </div>
 ...
 variant="outline" 
 size="sm" 
 className="flex-1 h-8 text-xs rounded-lg border-slate-200 hover:bg-orange-50 hover:border-orange-200 hover:text-orange-600 "
 ...
 variant="outline" 
 size="sm" 
 className="h-8 w-8 p-0 text-red-500 hover:text-red-600 hover:bg-red-50 hover:border-red-200 rounded-lg border-slate-200 "
