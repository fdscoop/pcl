...
export default function HomeClient() {
 ...
 <div className="mb-6">
 <a
 href="/PCL-app-v1.8.0.apk"
 download="PCL-app-v1.8.0.apk"
 className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-3 rounded-full shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
 >
 <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
 <path d="M17.523 7.39c-.013-1.177-.19-2.092-.48-2.822-.303-.766-.707-1.416-1.218-1.927a5.376 5.376 0 00-1.927-1.218c-.73-.29-1.645-.467-2.822-.48C9.898.93 9.566.917 6.999.917s-2.899.013-3.908.026c-1.177.013-2.092.19-2.822.48-.766.303-1.416.707-1.927 1.218A5.376 5.376 0 00.124 4.568c-.29.73-.467 1.645-.48 2.822C-.37 8.568-.383 8.9-.383 11.467s.013 2.899.026 3.908c.013 1.177.19 2.092.48 2.822.303.766.707 1.416 1.218 1.927a5.376 5.376 0 001.927 1.218c.73.29 1.645.467 2.822.48 1.009.013 1.341.026 3.908.026s2.899-.013 3.908-.026c1.177-.013 2.092-.19 2.822-.48a5.376 5.376 0 001.927-1.218 5.376 5.376 0 001.218-1.927c.29-.73.467-1.645.48-2.822.013-1.009.026-1.341.026-3.908s-.013-2.899-.026-3.908z"/>
 </svg>
 <span className="text-base sm:text-lg">Download Android App</span>
 <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
 </svg>
 </a>
 <p className="text-white/80 text-xs sm:text-sm mt-2">v1.8.0 • Latest Release • 6.1MB</p>
 </div>
 ...
 <Card className="card-hover bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 shadow-2xl overflow-hidden">
 ...
 Download the PCL Mobile App
 </h2>
 <p className="text-lg text-slate-700 mb-6 leading-relaxed">
 Get the complete PCL experience on your Android device. Manage your profile, sign contracts, track matches, and stay connected with your club - all from your phone.
 </p>
 ...
 <div>
 <p className="font-semibold text-slate-900">Mobile-Optimized Interface</p>
 <p className="text-sm text-slate-600">Designed specifically for smartphones with intuitive navigation</p>
 </div>
 </div>
 <div className="flex items-start gap-3">
 <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
 ...
 <p className="text-sm text-slate-600">Get instant updates about matches, contracts, and club activities</p>
 </div>
 </div>
 <div className="flex items-start gap-3">
 <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
 ...
 <div>
 <p className="font-semibold text-slate-900">Contract Signing on Mobile</p>
 <p className="text-sm text-slate-600">Review and sign contracts digitally from anywhere</p>
 </div>
 </div>
 </div>
 ...
 href="/PCL-app-v1.8.0.apk"
 download="PCL-app-v1.8.0.apk"
 className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
 >
 ...
 <div className="text-xs text-green-100">v1.8.0 • 6.1MB</div>
 </div>
 ...
 <strong>Note:</strong> Currently available for Android devices. iOS version coming soon!
 </p>
 </div>
 ...
 <svg className="relative w-64 h-64 text-green-600" fill="currentColor" viewBox="0 0 24 24">
 <path d="M17.523 7.39c-.013-1.177-.19-2.092-.48-2.822-.303-.766-.707-1.416-1.218-1.927a5.376 5.376 0 00-1.927-1.218c-.73-.29-1.645-.467-2.822-.48C9.898.93 9.566.917 6.999.917s-2.899.013-3.908.026c-1.177.013-2.092.19-2.822.48-.766.303-1.416.707-1.927 1.218A5.376 5.376 0 00.124 4.568c-.29.73-.467 1.645-.48 2.822C-.37 8.568-.383 8.9-.383 11.467s.013 2.899.026 3.908c.013 1.177.19 2.092.48 2.822.303.766.707 1.416 1.218 1.927a5.376 5.376 0 001.927 1.218c.73.29 1.645.467 2.822.48 1.009.013 1.341.026 3.908.026s2.899-.013 3.908-.026c1.177-.013 2.092-.19 2.822-.48a5.376 5.376 0 001.927-1.218 5.376 5.376 0 001.218-1.927c.29-.73.467-1.645.48-2.822.013-1.009.026-1.341.026-3.908s-.013-2.899-.026-3.908z"/>
