...
export default function AdminDashboard() {
 ...
 <Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50 hover:shadow-xl transition-shadow">
 <CardHeader>
 ...
 <Button variant="outline" className="w-full h-20 flex-col gap-2 border-2 hover:border-orange-500 hover:bg-orange-50 ">
 <FileCheck className="w-6 h-6 text-orange-600" />
 <span className="font-semibold">Pending Stadiums</span>
 </Button>
 </Link>
 <Link href="/dashboard/admin/club-verification?filter=pending">
 <Button variant="outline" className="w-full h-20 flex-col gap-2 border-2 hover:border-blue-500 hover:bg-blue-50 ">
 <Building2 className="w-6 h-6 text-blue-600" />
 <span className="font-semibold">Pending Clubs</span>
 </Button>
 </Link>
 <Link href="/dashboard/admin/users?filter=new">
 <Button variant="outline" className="w-full h-20 flex-col gap-2 border-2 hover:border-purple-500 hover:bg-purple-50 ">
 <Users className="w-6 h-6 text-purple-600" />
 <span className="font-semibold">New Users</span>
 </Button>
 </Link>
 <Link href="/dashboard/admin/stadium-documents?filter=rejected">
 <Button variant="outline" className="w-full h-20 flex-col gap-2 border-2 hover:border-red-500 hover:bg-red-50 ">
