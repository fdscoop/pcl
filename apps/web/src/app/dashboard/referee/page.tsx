...
export default function RefereeDashboard() {
 ...
 <span className="px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-amber-100 to-orange-100 text-amber-700 ">
 ...
 {/* Tips Section */}
 <ModernCard className="p-6 bg-gradient-to-br from-orange-50 to-amber-50 border-orange-200 ">
