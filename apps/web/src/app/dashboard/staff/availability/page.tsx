...
export default function StaffAvailability() {
  ...
  const loadAvailability = async () => {
    try {
      ...
      setIsAvailable(staffData.is_available || false)
      setAvailabilityCalendar(staffData.availability_calendar)
    } catch (error) {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your staff profile and invitations</CardDescription>
        </CardHeader>
        <CardContent>
