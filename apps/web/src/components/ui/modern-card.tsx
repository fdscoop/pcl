...
const StatCard = ({ title, value, subtitle, icon: Icon, trend, color = 'blue' }: StatCardProps) => {
 ...
 blue: "from-blue-500 to-indigo-500 text-blue-600 bg-blue-100 ",
 green: "from-emerald-500 to-teal-500 text-emerald-600 bg-emerald-100 ",
 purple: "from-purple-500 to-pink-500 text-purple-600 bg-purple-100 ",
 red: "from-red-500 to-rose-500 text-red-600 bg-red-100 "
 }
