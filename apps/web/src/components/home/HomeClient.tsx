    ...
    <div className="min-h-screen bg-background">
      ...
      {showMatchDetails && selectedMatch && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={() => setShowMatchDetails(false)}>
          <div className="bg-white dark:bg-gray-900 rounded-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
            {/* Modal Header */}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className={`rounded-lg p-4 ${
                selectedMatch.status === 'live' ? 'bg-red-50 dark:bg-red-950/20 border-2 border-red-500' :
                selectedMatch.status === 'upcoming' ? 'bg-blue-50 dark:bg-blue-950/20 border-2 border-blue-500' :
                  ...
                  <div className="flex items-center gap-3">
                    {selectedMatch.status === 'live' && (
                      <>
                        ...
                        <span className="text-lg font-bold text-red-600 dark:text-red-400">LIVE MATCH</span>
                      </>
                    )}
                    {selectedMatch.status === 'upcoming' && (
                      <span className="text-lg font-bold text-blue-600 dark:text-blue-400">UPCOMING MATCH</span>
                    )}
                    {selectedMatch.status === 'completed' && (
                      <span className="text-lg font-bold text-green-600 dark:text-green-400">MATCH COMPLETED</span>
                    )}
                  </div>
              ...
              {selectedMatch.status === 'upcoming' && (
                <Card className="border-blue-200 dark:border-blue-800">
                  <CardHeader>
                    <CardTitle className="text-blue-600 dark:text-blue-400">Match Preview</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <p className="text-muted-foreground">
            ...
            {/* Modal Footer */}
            <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-6 py-4 flex justify-end gap-3 z-10">
