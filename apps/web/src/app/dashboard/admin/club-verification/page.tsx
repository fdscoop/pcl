                    ...
                    <div className="space-y-3 pt-3 border-t">
                      ...
                      {selectedClub.payout_account && (
                        <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
                          <p className="text-xs font-semibold text-blue-900 dark:text-blue-200 mb-2">Bank Details</p>
                          <div className="space-y-1 text-xs">
                            <div className="flex justify-between">
                              <span className="text-blue-800 dark:text-blue-300">Account Holder</span>
                              <span className="font-medium">{selectedClub.payout_account.account_holder_name}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-blue-800 dark:text-blue-300">Account Number</span>
                              <span className="font-mono font-medium">****{selectedClub.payout_account.account_number.slice(-4)}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-blue-800 dark:text-blue-300">IFSC Code</span>
                              <span className="font-mono font-medium">{selectedClub.payout_account.ifsc_code}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-blue-800 dark:text-blue-300">Bank</span>
                      ...
                      <div className="space-y-3 pt-3 border-t">
                        ...
                        <div className="space-y-2">
                          {selectedClub.owner.stadiums.map((stadium) => (
                            <div key={stadium.id} className="p-3 rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
