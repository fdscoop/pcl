...
export default function RefereeCertifications() {
 ...
 <p className="text-slate-500 mt-1">Manage your referee certifications</p>
 </div>
 </div>
 ...
 <div>
 <h2 className="font-semibold text-lg text-slate-900 ">Add New Certification</h2>
 <p className="text-sm text-slate-500 ">Add your referee certification details</p>
 </div>
 </div>
 
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div className="space-y-2">
 <Label htmlFor="certification_name" className="text-slate-700 ">Certification Name *</Label>
 <Input
 ...
 <div className="space-y-2">
 <Label htmlFor="certification_type" className="text-slate-700 ">Type *</Label>
 <Select
 ...
 <div className="space-y-2">
 <Label htmlFor="issuing_authority" className="text-slate-700 ">Issuing Authority *</Label>
 <Input
 ...
 <div className="space-y-2">
 <Label htmlFor="certificate_number" className="text-slate-700 ">Certificate Number</Label>
 <Input
 ...
 <div className="space-y-2">
 <Label htmlFor="issue_date" className="text-slate-700 ">Issue Date *</Label>
 <Input
 id="issue_date"
 type="date"
 ...
 <div className="space-y-2">
 <Label htmlFor="expiry_date" className="text-slate-700 ">Expiry Date *</Label>
 <Input
 id="expiry_date"
 type="date"
 ...
 <div className="p-4 rounded-2xl bg-gradient-to-br from-purple-100 to-pink-100 mb-4">
 <FileText className="h-12 w-12 text-purple-600 " />
 </div>
 <h3 className="text-xl font-semibold text-slate-900 mb-2">No Certifications Yet</h3>
 ...
 <div>
 <h3 className="font-semibold text-lg text-slate-900 flex items-center flex-wrap gap-2">
 {cert.certification_name}
 {isExpired(cert.expiry_date) && (
 <span className="px-2 py-0.5 text-xs font-semibold rounded-full bg-red-100 text-red-700 ">Expired</span>
 )}
 </h3>
 ...
 <div>
 <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Certificate #</p>
 <p className="font-medium text-slate-900 mt-1">{cert.certificate_number || 'N/A'}</p>
 </div>
 <div>
 <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Issue Date</p>
 <p className="font-medium text-slate-900 mt-1">{formatDate(cert.issue_date)}</p>
 </div>
 <div>
 <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Expiry Date</p>
 <p className="font-medium text-slate-900 mt-1">{formatDate(cert.expiry_date)}</p>
 </div>
 <div>
 <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Status</p>
 <p className="font-medium text-slate-900 mt-1 capitalize">{cert.verification_status}</p>
 </div>
 </div>
 ...
 <p className="text-sm font-semibold text-amber-800 ">Verification Notes:</p>
